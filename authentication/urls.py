from .views import RegistrationView,VerificationView,CompletePasswordreset,UsernameValidationView,EmailValidationView,LoginView,LogoutView,RequestPasswordView, ProfileView, DeleteAccount
...
urlpatterns = [
    ...
    path('delete-account',DeleteAccount.as_view(),name="suppcompte"),
