from .views import RegistrationView,VerificationView,CompletePasswordreset,UsernameValidationView,EmailValidationView,LoginView,LogoutView,RequestPasswordView
