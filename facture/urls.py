...
urlpatterns = [
    ...
    path('exporter_facture_xls/<id>',csrf_exempt(views.export_facture_excel),name="exportXls"),
    path('exporter_facture_pdf/<id>',csrf_exempt(views.export_facture_pdf),name="exportPdf"),
